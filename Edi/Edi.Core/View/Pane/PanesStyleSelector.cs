namespace Edi.Core.View.Pane
{
    ...
    public class PanesStyleSelector : StyleSelector
  {
                                                     ...
                                                     System.Windows.DependencyObject container)
    {
      ...
      Style o;
      Type t = item.GetType();
      this._StyleDirectory.TryGetValue(t, out o);
    ...
    {
      if (this._StyleDirectory == null)
        this._StyleDirectory = new Dictionary<Type, Style>();

      this._StyleDirectory.Add(typeOfViewmodel, styleOfView);
    }
    #endregion methods
  }
}
