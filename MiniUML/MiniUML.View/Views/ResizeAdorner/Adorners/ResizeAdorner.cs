namespace MiniUML.View.Views.ResizeAdorner.Adorners
{
    ...
    public class ResizeAdorner : Adorner
    {
        ...
        private ResizeChrome _Chrome = null;
        #endregion fields
        ...
        public ResizeAdorner(ContentControl designerItem,
          ...
          : base(designerItem)
        {
            _Chrome = new ResizeChrome(dragDeltaAction_DelegateFunction);
            _Visuals = new VisualCollection(this);

            _Visuals.Add(_Chrome);
            _Chrome.DataContext = designerItem;  // Apply data context from this object to chrome object
        }
